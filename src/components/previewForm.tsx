...
function PreviewForm() {
  ...
  return (
    <div className="grid place-items-center h-screen">
      {renderImg
       && <ImagePreview createdAt={getValues('createdAt')} id={getValues('id')} slug={getValues('slug')} categories={getValues('categories')} cover_img_url={getValues('cover_img_url')} />}
      <form
      ...
      >
        ...
        <div className="md:flex md:items-center mb-6">
          ...
          <div className="md:w-2/3">
            <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="inline-coverImgUrl" type="text" placeholder="https://upload.wikimedia.org/wikipedia/en/c/cd/Dwight_Schrute.jpg" {...register('cover_img_url', { required: true })} />
          </div>
        </div>
